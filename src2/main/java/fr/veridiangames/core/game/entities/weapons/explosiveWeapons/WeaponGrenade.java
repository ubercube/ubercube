...
public class WeaponGrenade extends ExplosiveWeapon
{
    ...
    public WeaponGrenade(int num)
    {
        ...
        this.setPosition(0);
        this.maxGrenade = num;
        this.grenadeCount = this.maxGrenade;
    }
	...
	public void update(GameCore core)
    {
        ...
        this.getTransform().getLocalPosition().z = 1 - this.force * 0.15f;
    }
	...
	public void onActionUp()
    {
        ...
        Grenade g = (Grenade) new Grenade(Indexer.getUniqueID(),
                this.holder.getID(),
                this.transform.getPosition().copy().add(this.holder.getTransform().getForward().copy().mul(1.5f)),
                this.transform.getRotation(), this.force * 0.9f).setNetwork(this.net);

        this.net.send(new GrenadeSpawnPacket(g), Protocol.TCP);
