...
public class FrustumCulling {
	...
	/**
	 * Use this function in a stable loop (Ticks / Updates)
	 * Updates the specified camera frustum view. 
	 * 
	 * @param camera
	 */
	...
	/**
	 * Use this function in a stable loop (Ticks / Updates)
	 * Don't forget to update the frustum view. 
	 * 
	 * @param position, radius
	 * @return true: if the position with it's radius is in the frustum view.
	 */
